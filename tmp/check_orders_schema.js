// Diagnosing orders table schema
...
async function checkSchema() {
    console.log("Checking orders table schema via direct fetch...");
    try {
        const response = await fetch(`${supabaseUrl}/rest/v1/orders?select=*&limit=1`, {
            headers: {
                'apikey': supabaseKey,
